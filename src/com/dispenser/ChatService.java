...
public class ChatService {
	...
	private static final String NAME = "TENET";
		...
		public void run() {
			...
			while (true) {
				try {
					...
					mmInStream.read(buf,0,available);
					String output=new String(buf);
					inData+=output;
					if(inData.contains("\n"))
					{
						mHandler.obtainMessage(MainActivity.MESSAGE_READ, inData.length(),
								   -1, inData.getBytes()).sendToTarget();
						inData="";
					}
					...
					buffer2 = buffer2.substring(0, buffer2.length()) + "\n";
